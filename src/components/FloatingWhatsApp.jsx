...
export default function FloatingWhatsApp() {
  // Configurações do seu WhatsApp
  const numeroWhatsApp = "5511910241998"; // Coloque o código do país (55) + DDD + Número
  const mensagemPadrao =
    "Olá! Estava navegando no site da Novo Tempo e gostaria de falar com um engenheiro sobre um projeto.";

  // Codifica a mensagem para o formato de link da web
